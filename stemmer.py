...
patterns = {"LV": "A|w|y",
            ...
            "NN": "(NCONJ? VOC? NNEG? PREP? (PX$|(NAME | DET? NSTEM AGREE) (((ALLAH|PRON)?) | CASE?)))",
...
STANDARDGROUPS = {"NN": ["NCONJ", "VOC", "NNEG", "PREP", "PX", "NAME", "DET", "NSTEM", "AGREE", "PRON", "ALLAH", "CASE"], 
...
DERIVGROUPS = {"NN": ["NCONJ", "VOC", "PREP", "NNEG", "PX", "NAME", "DET", "NSTEM", "NN", "PRON", "ALLAH"], 
               "VB": ["VCONJ", "NEG", "VSTEM", "VB", "PRON1", "PRON2"]}
DERIVGROUPS = {"NN": ["NCONJ", "VOC", "PREP", "NNEG", "PX", "NAME", "DET", "NSTEM", "PRON", "ALLAH"], 
               "VB": ["VCONJ", "NEG", "VSTEM", "VB", "PRON1", "PRON2"]}
